...
public class AccountWrapper implements Comparable<AccountWrapper> {
    ...
    private static String[] COMPARABLE_HEADERS = new String[]{NAME, PSEUDO, PASSWORD, NOTES};


    private static SimpleDateFormat dateFormat = new SimpleDateFormat("yyyy-MM-dd HH:mm");


    public AccountWrapper(String pseudo, String name, String notes, String password) {
    ...
    public AccountWrapper(Map<String, String> obj) {
        account = obj;
    }//end constructor
    ...
    public boolean equals(Object o) {
        return o instanceof AccountWrapper && this.compareTo((AccountWrapper) o) == 0;
    }
